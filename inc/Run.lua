...
SUDO_USER = redis:hgetall(dox..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(dox..':WELCOME_BOT'),[[▪️ مرحباً انا بوت ]]..redis:get(dox..':NameBot:')..[[ .
▪️ اختـصاصـي حمايـة الـمجموعات
▪️ تأكد من رفعـك للبـوت مشـرف في مجموعـتك واكتب تفعـيل 
قناة سورس دوكس ❥ @Sourcedox
