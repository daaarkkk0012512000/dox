...
َ▇     ▇    ,▇        ▇   @HH22H
َ                     ,▇
تم تطوير السورس بواسطه مطور سورس التركي ✾
#-------------------------------------------------------------------
]]
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(dox..":NameBot:")
...
var =  'الجوكر ياهه'
elseif redis:sismember(dox..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(dox..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(dox..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(dox..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(dox..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(dox..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(dox..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(dox..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(dox..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(dox..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(dox..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(dox..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(dox..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(dox..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(dox..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(dox..':SUDO_BOT:')
message = '⋆ ** قائمه الـمـطـوريـن : \n\n`⋆ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(dox..'username:'..v)
local count = redis:scard(dox..'mtwr_count'..v)
...
local monsha = redis:smembers(dox..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n⋆ قائمه المدراء :*\n\n'
local list = redis:smembers(dox..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(dox..'admins:'..msg.chat_id_)
...
local list = redis:smembers(dox..'whitelist:'..msg.chat_id_)
...
if redis:sismember(dox..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(dox..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(dox..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(dox..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(dox..'gban_users')
...
local list = redis:smembers(dox..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(dox..':Filter_Word:'..msg.chat_id_,word) then 
return  "⋆ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(dox..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(dox..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(dox..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(dox..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(dox..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(dox..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(dox..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(dox..'group:ids')
message = '⋆ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(dox..'group:name'..v)
if info then 
...
redis:del(
dox..'group:add'..id_group,
dox..'lock_link'..id_group, 
dox..'lock_id'..id_group,
dox..'lock_spam'..id_group, 
dox..'lock_webpage'..id_group,
dox..'lock_markdown'..id_group,
dox..'lock_flood'..id_group,
dox..'lock_bots'..id_group,
dox..'mute_forward'..id_group,
dox..'mute_contact'..id_group,
dox..'mute_location'..id_group,
dox..'mute_document'..id_group,
dox..'mute_keyboard'..id_group,
dox..'mute_game'..id_group,
dox..'mute_inline'..id_group,
dox..'lock_username'..id_group,
dox..'num_msg_dox'..id_group,
dox..'replay'..id_group
)
redis:srem(dox..'group:ids',id_group)
end
...
redis:hset(dox..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(dox..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(dox..'group:add'..msg.chat_id_) then  return '⋆ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(dox..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(dox..':addnumberusers') or 0)
...
local lock_service = redis:get(dox..'lock_service')
if lock_service then 
sendMsg(msg.chat_id_,msg.id_,'⋆*تم تفعيل المجموعه . \n*⋆ ورفع كل المشرفين\n [SOURCE DOX..🖤](t.me/SourceDOX)')
else
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(dox..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(dox..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
dox..'group:add'..msg.chat_id_,true,
dox..'lock_link'..msg.chat_id_,true, 
dox..'lock_id'..msg.chat_id_,true,
dox..'lock_spam'..msg.chat_id_,true,
dox..'lock_webpage'..msg.chat_id_,true,
dox..'lock_markdown'..msg.chat_id_,true,
dox..'lock_flood'..msg.chat_id_,true,
dox..'lock_bots'..msg.chat_id_,true,
dox..'mute_forward'..msg.chat_id_,true,
dox..'mute_contact'..msg.chat_id_,true,
dox..'mute_location'..msg.chat_id_,true,
dox..'mute_document'..msg.chat_id_,true,
dox..'mute_keyboard'..msg.chat_id_,true,
dox..'mute_game'..msg.chat_id_,true,
dox..'mute_inline'..msg.chat_id_,true,
dox..'lock_username'..msg.chat_id_,true,
dox..'num_msg_dox'..msg.chat_id_,5, 
dox..'replay'..msg.chat_id_,true
)

redis:sadd(dox..'group:ids',msg.chat_id_) 
redis:sadd(dox..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(dox..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(dox..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(dox..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(dox..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(dox..'username:'..UserID,'username',Resolv)
redis:sadd(dox..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(dox..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(dox..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(dox..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(dox..'username:'..UserID,'username',Resolv)
redis:sadd(dox..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(dox..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(dox..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(dox..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(dox..'username:'..UserID, 'username', Resolv)
redis:sadd(dox..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(dox..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(dox..'whitelist:'..ChatID,UserID)
...
if redis:sismember(dox..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(dox..'username:'..UserID, 'username', Resolv)
redis:sadd(dox..'owners:'..ChatID,UserID)
...
if redis:sismember(dox..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(dox..'username:'..UserID, 'username', Resolv)
redis:sadd(dox..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(dox..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(dox..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(dox..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(dox..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(dox..'msgs:'..UserID..':'..ChatID) or 1
...
elseif UserID == 1019610884 then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك حظر التركي\n") 
elseif UserID == 1424388256 then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك حظر البابا جاك\n") 
elseif UserID == 1282382975 then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك حظر دارك\n") 
elseif UserID == 1317966118 then 
...
redis:hset(dox..'username:'..UserID, 'username', Resolv)
redis:sadd(dox..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(dox..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(dox..'banned:'..ChatID,UserID)
...
elseif UserID == 1019610884 then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك كتم التركي\n") 
elseif UserID == 1282382975 then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك كتم دارك\n") 
elseif UserID == 1424388256 then 
...
if redis:sismember(dox..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(dox..'username:'..UserID, 'username', Resolv)
redis:sadd(dox..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(dox..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(dox..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(dox..'username:'..UserID, 'username',Resolv)
redis:sadd(dox..'gban_users',UserID)
...
redis:srem(dox..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم الغاء حظره العام \n',17,USERCAR) 
end
...
elseif UserID == 1019610884 then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد التركي\n") 
elseif UserID == 1282382975 then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد دارك\n") 
elseif UserID == 1424388256 then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك كتم البابا جاك\n") 
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك كتم الجوكر ياهه\n") 
...
if redis:sismember(dox..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(dox..'username:'..UserID, 'username', Resolv)
redis:sadd(dox..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(dox..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(dox..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
elseif UserID == 1282382975 then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك تقييد دارك\n") 
elseif UserID == 1019610884 then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك تقييد التركي\n") 
elseif UserID == 1317966118 then 
...
redis:hset(dox..'username:'..UserID, 'username', UserName)
redis:sadd(dox..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(dox..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'⋆ **العضو » ❪ '..UserName..' ❫\n⋆ **الايدي » ❪ `'..UserID..'` ❫\n⋆ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(dox..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(dox..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(dox..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(dox..'username:'..UserID, 'username', Resolv)
redis:sadd(dox..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(dox..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(dox..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'⋆ **العضو » '..USERNAME..' \n⋆ ** الايدي » (`'..UserID..'`)\n⋆ **انه بالتأكيد ليس مطور \n') end
redis:srem(dox..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(dox..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(dox..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(dox..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(dox..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*⋆*` اعدادات المجموعه :` \n"
.."\n⋆ التعديل «» "..(redis:get(dox..'lock_edit'..msg.chat_id_) or 'false')
.."\n⋆ الروابط «» "..(redis:get(dox..'lock_link'..msg.chat_id_) or 'false')
.."\n⋆ التاك «» "..(redis:get(dox..'lock_tag'..msg.chat_id_) or 'false')
.."\n⋆ المعرفات «» "..(redis:get(dox..'lock_username'..msg.chat_id_) or 'false')
.."\n⋆ التكرار «» "..(redis:get(dox..'lock_flood'..msg.chat_id_) or 'false')
.."\n⋆ الكلايش «» "..(redis:get(dox..'lock_spam'..msg.chat_id_) or 'false')
.."\n⋆ الويب «» "..(redis:get(dox..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⋆ الماركدوان «» "..(redis:get(dox..'lock_markdown'..msg.chat_id_) or 'false')
.."\n⋆ بالطرد البوتات «» "..(redis:get(dox..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n⋆ البوتات «» "..(redis:get(dox..'lock_bots'..msg.chat_id_) or 'false')
.."\n⋆ عدد التكرار «» "..(redis:get(dox..'num_msg_dox'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⋆`اعدادات الوسائط :`\n"
.."\n*⋆ *المتحركه «» "..(redis:get(dox..'mute_gif'..msg.chat_id_) or 'false')
.."\n⋆ الدردشه «» "..(redis:get(dox..'mute_text'..msg.chat_id_) or 'false')
.."\n⋆ الانلاين «» "..(redis:get(dox..'mute_inline'..msg.chat_id_) or 'false')
.."\n⋆ الالعاب «» "..(redis:get(dox..'mute_game'..msg.chat_id_) or 'false')
.."\n⋆ الصور «» "..(redis:get(dox..'mute_photo'..msg.chat_id_) or 'false')
.."\n⋆ الفيديو «» "..(redis:get(dox..'mute_video'..msg.chat_id_) or 'false')
.."\n⋆ البصمات «» "..(redis:get(dox..'mute_audio'..msg.chat_id_) or 'false')
.."\n⋆ الصوت «» "..(redis:get(dox..'mute_voice'..msg.chat_id_) or 'false')
.."\n⋆ الملصقات «» "..(redis:get(dox..'mute_sticker'..msg.chat_id_) or 'false')
.."\n⋆ الجهات «» "..(redis:get(dox..'mute_contact'..msg.chat_id_) or 'false')
.."\n⋆ التوجيه «» "..(redis:get(dox..'mute_forward'..msg.chat_id_) or 'false')
.."\n⋆ الموقع «» "..(redis:get(dox..'mute_location'..msg.chat_id_) or 'false')
.."\n⋆ الملفات «» "..(redis:get(dox..'mute_document'..msg.chat_id_) or 'false')
.."\n⋆ الاشعارات «» "..(redis:get(dox..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n⋆ الكيبورد «» "..(redis:get(dox..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⋆*`اعدادات اخرى : `"
.."\n\n*⋆*الترحيب «» "..welcomex
.."\n*⋆*الردود «» "..replayx
...
.."\n*⋆*الويب «» "..(redis:get(dox..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*⋆*الماركدوان «» "..(redis:get(dox..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*⋆*البوتات بالطرد «» "..(redis:get(dox..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*⋆*البوتات «» "..(redis:get(dox..'lock_bots'..msg.chat_id_) or 'false')
.."\n*⋆*عدد التكرار «» "..(redis:get(dox..'num_msg_dox'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⋆*اعدادات التقـييد :\n"
.."\n*⋆*التقييد بالتوجيه «» "..(redis:get(dox..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد بالصور «» "..(redis:get(dox..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد بالروابط «» "..(redis:get(dox..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد بالمتحركه «» "..(redis:get(dox..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد الفيديو «» "..(redis:get(dox..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
