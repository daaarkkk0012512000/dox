...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/jack1eljoker1/dox/main/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - D  O       ')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/dox/main/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - D  O       ')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/dox/main/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% -D  O      ')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/dox/main/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/dox/main/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/dox/main/plugins/games.lua','./plugins/games.lua')
