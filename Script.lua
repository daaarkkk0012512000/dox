...
redis:set(dox.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(dox..'lock:join:'..msg.chat_id_,true)
...
redis:del(dox..'lock:join:'..msg.chat_id_)
return "*✦ ** أهلا عزيزي *"..msg.TheRankCmd.."*\n✦ ** تم فتح الدخول بالرابط \n*" 
end


local function idox(msg,MsgText)

Channel = redis:get(dox..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(dox..'joinchnl') then
...
redis:setex(dox..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(dox..'CheckExpire::'..msg.chat_id_) then 
redis:set(dox..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(dox..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(dox..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(dox..'CheckExpire::'..msg.chat_id_) then 
redis:set(dox..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(dox..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(dox..'CheckExpire::'..msg.chat_id_) then 
redis:set(dox..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(dox..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(dox..'CheckExpire::'..msg.chat_id_) then 
redis:set(dox..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(dox..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(dox..'group:name'..msg.chat_id_) or '')
redis:set(dox..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(dox..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. dox..'')
...
if not msg.Director and redis:get(dox..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(dox..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "✦ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(dox..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(dox..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(dox..'admins:'..msg.chat_id_)
redis:del(dox..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(dox..'owners:'..msg.chat_id_)
redis:del(dox..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(dox..'whitelist:'..msg.chat_id_)
redis:del(dox..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(dox..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(dox..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(dox..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(dox..'linkGroup'..msg.sender_user_id_,300,true)
return '✦ عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(dox..'linkGroup'..msg.chat_id_) then 
return "✦ ** اوه لا يوجد رابط .\n✦ **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(dox..'group:name'..msg.chat_id_)
local GroupLink = redis:get(dox..'linkGroup'..msg.chat_id_)
...
local Text = "✦ رابـط الـمـجـمـوعه ✦ \n"..Flter_Markdown(redis:get(dox..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(dox..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(dox..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "✦ ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(dox..':Filter_Word:'..msg.chat_id_)
...
redis:del(dox..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(dox..'welcome:msg'..msg.chat_id_) then 
return "✦ ** اوه هنالك خطأ .\n✦ عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(dox..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(dox..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "✦ عذراً لا يوجد منشى اساسي \n!" 
end
redis:del(dox..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "✦ **هذا الامر يخص {المطور} فقط  \n" end
local NumMnsha = redis:scard(dox..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "✦ عذراً لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(dox..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(dox..'banned:'..msg.chat_id_)
if #list == 0 then return "*✦ لا يوجد مستخدمين محظورين  *" end
message = '✦ ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(dox..'banned:'..msg.chat_id_)
return "✦ **أهلا عزيزي "..msg.TheRankCmd.."   \n✦  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(dox..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "✦ ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(dox..'is_silent_users:'..msg.chat_id_)
...
redis:del(dox..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "✦ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(dox..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(dox..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "✦ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(dox..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(dox..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(dox..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(dox..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(dox..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(dox..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(dox..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(dox..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(dox..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(dox..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(dox.."getidstatus"..msg.chat_id_) == "Photo" then
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(dox..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(dox..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(dox..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(dox..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(dox..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(dox..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(dox..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(dox..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(dox..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(dox..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "✦ **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '✦ **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(dox..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(dox..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "✦ **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(dox..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(dox..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "✦ **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(dox..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
.."[✦](https://t.me/SourceDOX) ~~~~~~~~~~~~~~~~~~[✦](https://t.me/SourceDOX) \n"
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(dox..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(dox..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(dox..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(dox..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(dox..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(dox..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(dox..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(dox..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(dox..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "✦ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(dox..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "✦ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(dox..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(dox..'welcome:msg'..msg.chat_id_))
else 
return "✦ **أهلا عزيزي "..msg.TheRankCmd.."  \n✦ نورت المجموعه \n" 
end 
end
...
local groups = redis:smembers(dox..'group:ids')
...
local pv = redis:smembers(dox..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(dox..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(dox..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[✦ اهلا انا بوت]]..redis:get(dox..':NameBot:')..[[ .
...
if not msg.SudoUser then return "✦ **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(dox..'group:ids',MsgText[2]) then
local name_gp = redis:get(dox..'group:name'..MsgText[2])
...
return redis:get(dox..":TEXT_SUDO") or '✦ لا توجد كليشه المطور .\n✦ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"✦ **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(dox..'lock_brod') then 
return "✦ ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(dox..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(dox..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(dox..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(dox..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "✦ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:del(dox..'welcom:witting'..msg.sender_user_id_,
dox..'rulse:witting'..msg.sender_user_id_,
dox..'rulse:witting'..msg.sender_user_id_,
dox..'name:witting'..msg.sender_user_id_,
dox..'about:witting'..msg.sender_user_id_,
dox..'fwd:all'..msg.sender_user_id_,
dox..'fwd:pv'..msg.sender_user_id_,
dox..'fwd:groups'..msg.sender_user_id_,
dox..'namebot:witting'..msg.sender_user_id_,
dox..'addrd_all:'..msg.sender_user_id_,
dox..'delrd:'..msg.sender_user_id_,
dox..'addrd:'..msg.sender_user_id_,
dox..'delrdall:'..msg.sender_user_id_,
dox..'text_sudo:witting'..msg.sender_user_id_,
dox..'addrd:'..msg.chat_id_..msg.sender_user_id_,
dox..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
redis:set(dox..":VERSION",GetVerison)
return false
else
...
return '✦ اصدار سورس دوكس : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'✦ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس دوكس يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
if not msg.SudoBase then return"✦ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return "✦ البوت شغال يسطا ." 
end

if (MsgText[1]== "ايدي" or MsgText[1]=="ايدي") and msg.type == "pv" then return  "\n✦ اهلاً عزيزي المطور ايديك :\n\n✦ "..msg.sender_user_id_.."\n"  end

if MsgText[1]== "قناة السورس" and msg.type == "pv" then
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/SourceDOX"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : دوكس](https://t.me/SourceDOX)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "قناه دارك" and msg.type == "pv" then
local inline = {{{text="اضغط هنا",url="https://t.me/DarkWritings"}}}
send_key(msg.sender_user_id_,'   [قناه دارك](https://t.me/DarkWritings)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "قناه التركي" and msg.type == "pv" then
local inline = {{{text="اضغط هنا",url="https://t.me/LLLL1X}}}
send_key(msg.sender_user_id_,'   [قناه التركي](https://t.me/LLLL1X)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "روم التركي" and msg.type == "pv" then
local inline = {{{text="اضغط هنا",url="https://t.me/ElturKeyyCHAT"}}}
send_key(msg.sender_user_id_,'   [روم التركي](https://t.me/ElturKeyyCHAT)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "Dark" and msg.type == "pv" then
local inline = {{{text="دارك السورس اضـغـط هـنـآ ",url="https://t.me/Ttnnt"}}}
send_key(msg.sender_user_id_,'   [المبرمج دارك](https://t.me/Ttnnt)' ,nil,inline,msg.id_)
return false
end
...
local inline = {{{text="مصنع بوتات المبرمج ",url="https://t.me/ElturkeyyMKbot"}}}
send_key(msg.sender_user_id_,'   [مصنع بوتات المبرمج](https://t.me/ElturkeyyMKbot)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "بوت دعم قنوات المبرمج" and msg.type == "pv" then
local inline = {{{text="بوت دعم قنوات المبرمج ",url="https://t.me/U6sbot"}}}
send_key(msg.sender_user_id_,'   [بوت دعم قنوات المبرمج](https://t.me/U6sbot)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "بوت ماركت المبرمج" and msg.type == "pv" then
local inline = {{{text="بوت ماركت المبرمج ",url="https://t.me/VMTVBOT"}}}
send_key(msg.sender_user_id_,'   [بوت ماركت المبرمج](https://t.me/VMTVBOT)' ,nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 💥" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"✦ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '✦ الاحصائيات . \n\n✦ **عدد المجموعات المفعله : '..redis:scard(dox..'group:ids')..'\n✦ **عدد المشتركين في البوت : '..redis:scard(dox..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"✦ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(dox..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(dox..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(dox..'replay:'..msg.chat_id_)
local photo 	= redis:exists(dox..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(dox..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(dox..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(dox..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(dox..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(dox..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(dox..'replay:'..msg.chat_id_,dox..'replay_photo:group:'..msg.chat_id_,dox..'replay_voice:group:'..msg.chat_id_,
dox..'replay_animation:group:'..msg.chat_id_,dox..'replay_audio:group:'..msg.chat_id_,dox..'replay_sticker:group:'..msg.chat_id_,dox..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(dox..'replay:all')
local photo 	= redis:exists(dox..'replay_photo:group:')
local voice 	= redis:exists(dox..'replay_voice:group:')
local imation 	= redis:exists(dox..'replay_animation:group:')
local audio 	= redis:exists(dox..'replay_audio:group:')
local sticker 	= redis:exists(dox..'replay_sticker:group:')
local video 	= redis:exists(dox..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(dox..'replay:all',dox..'replay_photo:group:',dox..'replay_voice:group:',dox..'replay_animation:group:',dox..'replay_audio:group:',dox..'replay_sticker:group:',dox..'replay_video:group:')
...
if not msg.SudoBase then return"✦ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(dox..'delrdall:'..msg.sender_user_id_,true) 
return "✦ حسننا عزيزي  .\n✦ الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(dox..'delrd:'..msg.sender_user_id_,true)
return "✦ حسننا عزيزي  .\n✦ الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "✦ *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(dox..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(dox..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(dox..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(dox..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(dox..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(dox..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(dox..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(dox..'replay:all')
local photo 	= redis:hkeys(dox..'replay_photo:group:')
local voice 	= redis:hkeys(dox..'replay_voice:group:')
local imation 	= redis:hkeys(dox..'replay_animation:group:')
local audio 	= redis:hkeys(dox..'replay_audio:group:')
local sticker 	= redis:hkeys(dox..'replay_sticker:group:')
local video 	= redis:hkeys(dox..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '✦ **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(dox..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(dox..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "✦ حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"✦ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(dox..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "✦ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n✦ " end
if not redis:get(dox..'lave_me'..msg.chat_id_) then 
return "✦ **أهلا عزيزي "..msg.TheRankCmd.."\n✦ ** المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(dox..'lave_me'..msg.chat_id_) 
return "✦ **أهلا عزيزي "..msg.TheRankCmd.."\n✦ ** تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "✦ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n✦ " end
if redis:get(dox..'lave_me'..msg.chat_id_) then 
return "✦ **أهلا عزيزي "..msg.TheRankCmd.."\n✦ ** المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(dox..'lave_me'..msg.chat_id_,true)  
...
✧𝙳𝙴𝚅₁ :[𝙴𝙻𝚃𝚄𝚁𝙺𝙴𝚈𝚈](https://t.me/M2ttt)
✧𝙳𝙴𝚅₂ :[𝙳𝙰𝚁𝙺](https://t.me/Ttnnt)

✧[𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷](https://t.me/SourceDoX)

✧[𝚃𝙾 𝚃𝙰𝙻𝙺 𝚃𝙾 𝚄𝚂](https://t.me/TwslMtbot)
...
if not msg.SudoBase then return"✦ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(dox..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"✦ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(dox..":UserNameChaneel")
if UserChaneel then
...
if redis:get(dox..'welc'..msg.chat_id_) == 'on' then
...
local hash = dox..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
mmd = redis:get(dox..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(dox..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(dox..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'✦ اهلا عزيزي \n✦ تم تثبيت الامر الجديد\n✓')
redis:del(dox..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "✦ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(dox..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(dox..'CmD:'..msg.chat_id_,cmd)
redis:srem(dox..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"✦ اهلا عزيزي\nالامر >"..cmd.."\n✦ تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "✦ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(dox..'CmD:'..msg.chat_id_)
redis:del(dox..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"✦ اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "✦ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(dox..'CmDlist:'..msg.chat_id_)
local t = '✦ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(dox..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(dox..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(dox..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(dox..'welc'..msg.chat_id_,'off')
redis:del(dox..'welc'..msg.chat_id_,'on')
else
...
function tophoto(kara,dox)   
if dox.content_.ID == "MessageSticker" then        
local bd = dox.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(dox..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(dox..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*✦ * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(dox..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/start" then 

if msg.SudoBase then
local text = '- شكراً لك لإستخدام سورس دوكس\n- أنت المطور الاساسي هنا\n—————————\n\n- يمكنك الأن التحكم بأوامر البوت عن طريق لوحة التحكم بالبوت\nفقط انقر على الأمر الذي اريده‏'
local keyboard = {
{"قناه التركي","قناه دارك"},
{"روم التركي"},
{"DARK","ELTURKEYY"},
{"مصنع بوتات المبرمج"},
...
redis:sadd(dox..'users',msg.sender_user_id_)
if redis:get(dox..'lock_service') then 
text = [[✦ أهلاً انا بوت   []]..redis:get(dox..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(dox.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(dox..'lock_twasel') then
...
redis:setex(dox.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(dox..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(dox..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(dox..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(dox..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(dox..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n✦ تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(dox..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(dox..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه صوره للرد بنجاح\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(dox..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(dox..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه بصمه صوت للرد بنجاح\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(dox..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(dox..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه متحركه للرد بنجاح\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(dox..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(dox..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه فيديو للرد بنجاح\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(dox..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(dox..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه للصوت للرد بنجاح\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(dox..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(dox..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(dox..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(dox..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(dox..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(dox..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(dox..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✦ تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(dox..'replay_photo:group:',klma,photo_id)
redis:del(dox..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه صوره للرد العام\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(dox..'replay_voice:group:',klma,voice_id)
redis:del(dox..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه بصمه صوت للرد العام\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(dox..'replay_animation:group:',klma,animation_id)
redis:del(dox..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه متحركه للرد العام\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(dox..'replay_video:group:',klma,video_id)
redis:del(dox..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه فيديو للرد العام\n✦ يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(dox..'replay_audio:group:',klma,audio_id)
redis:del(dox..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه للصوت للرد العام\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(dox..'replay_sticker:group:',klma,sticker_id)
redis:del(dox..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(dox..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(dox..":ForceSub:"..msg.sender_user_id_)
...
redis:set(dox..":UserNameChaneel",msg.text)
...
if redis:get(dox..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(dox..'namebot:witting'..msg.sender_user_id_)
redis:set(dox..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"✦ تم تغير اسم البوت  .\n✦ الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(dox..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(dox..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(dox..'replay_photo:group:',msg.text)
redis:hdel(dox..'replay_voice:group:',msg.text)
redis:hdel(dox..'replay_animation:group:',msg.text)
redis:hdel(dox..'replay_audio:group:',msg.text)
redis:hdel(dox..'replay_sticker:group:',msg.text)
redis:hdel(dox..'replay_video:group:',msg.text)
redis:setex(dox..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"✦ جيد , يمكنك الان ارسال جوا ب الردالعام \n✦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(dox..'delrdall:'..msg.sender_user_id_) then
redis:del(dox..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(dox..'replay:all',msg.text)
local photo =redis:hget(dox..'replay_photo:group:',msg.text)
local voice = redis:hget(dox..'replay_voice:group:',msg.text)
local animation = redis:hget(dox..'replay_animation:group:',msg.text)
local audio = redis:hget(dox..'replay_audio:group:',msg.text)
local sticker = redis:hget(dox..'replay_sticker:group:',msg.text)
local video = redis:hget(dox..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'✦ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(dox..'replay:all',msg.text)
redis:hdel(dox..'replay_photo:group:',msg.text)
redis:hdel(dox..'replay_voice:group:',msg.text)
redis:hdel(dox..'replay_audio:group:',msg.text)
redis:hdel(dox..'replay_animation:group:',msg.text)
...
if redis:get(dox..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(dox..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(dox..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "✦ ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(dox..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(dox..'welcom:witting'..msg.sender_user_id_) 
redis:set(dox..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"✦ ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(dox..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(dox..'rulse:witting'..msg.sender_user_id_) 
redis:set(dox..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'✦ ** مرحبآ عزيزي\n✦ تم حفظ القوانين بنجاح .\n✦ ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(dox..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(dox..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(dox..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(dox..'linkGroup'..msg.sender_user_id_,link) 
redis:set(dox..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'✦ تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(dox..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(dox..'about:witting'..msg.sender_user_id_) 
...
if redis:get(dox..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(dox..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(dox..'users')  
local groups = redis:smembers(dox..'group:ids')
...
if redis:get(dox..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(dox..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(dox..'users')
if #pv >= 300 then
...
if redis:get(dox..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(dox..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(dox..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(dox..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(dox..':WELCOME_BOT'),[[✦أهلاً انا بوت ]]..redis:get(dox..':NameBot:')..[[
✦ أختصاصي حماية‌‏ المجموعات
✦ مـن السبام والتوجيه‌‏ والتكرار والخ...
...
if msg.forward_info and redis:get(dox..'fwd:'..msg.sender_user_id_) then
redis:del(dox..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(dox..'users')
local groups = redis:smembers(dox..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(dox..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(dox..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(dox..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(dox..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(dox..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(dox..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(dox..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(dox..'replay:'..msg.chat_id_,msg.text)
redis:hdel(dox..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(dox..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(dox..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(dox..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(dox..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(dox..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(dox..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"✦ جيد , يمكنك الان ارسال جواب الرد \n✦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(dox..'delrd:'..msg.sender_user_id_) then
redis:del(dox..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(dox..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(dox..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(dox..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(dox..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(dox..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(dox..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(dox..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'✦ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(dox..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(dox..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(dox..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(dox..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(dox..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(dox..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(dox..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(dox..'welcome:msg'..msg.chat_id_) or "✦ اهلاً عزيزي {الاسم}\n✦ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n✦ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(dox..'rulse:msg'..msg.chat_id_) or "✦ مرحباً عزيري القوانين كلاتي .\n✦ ممنوع نشر الروابط\n✦ ممنوع التكلم او نشر صور اباحيه\n✦ ممنوع  اعاده توجيه\n✦ ممنوع التكلم بالسياسة\n✦ الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(dox..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(dox..'welcome:msg'..msg.chat_id_) or "✦ اهلن بك عزيزي {الاسم}\n✦ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n✦ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(dox..'rulse:msg'..msg.chat_id_) or "✦ مرحباً عزيري القوانين كلاتي .\n✦ ممنوع نشر الروابط\n✦ ممنوع التكلم او نشر صور اباحيه\n✦ ممنوع  اعاده توجيه\n✦ ممنوع التكلم بالسياسة\n✦ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(dox..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(dox..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(dox..'welcome:get'..msg.chat_id_)
end
redis:setex(dox..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(dox..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(dox..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_dox = (redis:get(dox..'num_msg_dox'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_dox) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(dox..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"✦ العضو » "..USERNAME.."\n✦ قمـت بتكرار اكثر مـن "..NUM_MSG_dox.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(dox..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(dox..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(dox..'lock_woring'..msg.chat_id_) and not redis:get(dox..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(dox..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(dox..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(dox..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'✦ ** لا يمكنني مسح الرساله المخالفه .\n✦ ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(dox..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(dox..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(dox..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(dox..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(dox..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(dox..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(dox..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(dox..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(dox..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(dox..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(dox..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(dox..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(dox..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(dox..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(dox..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(dox..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(dox..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(dox..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(dox..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(dox..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(dox..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(dox..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(dox..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(dox..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(dox..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(dox..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(dox..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(dox..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(dox..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(dox..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(dox..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dox..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(dox..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dox..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dox..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dox..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(dox..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dox..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(dox..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dox..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dox..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(dox..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
sendMsg(msg.chat_id_,msg.id_,nnn[math.random(#nnn)]) 
  elseif Text== "جاك" or Text== "البابا جاك" then return  sendMsg(msg.chat_id_,msg.id_,"[اقمد من القمدان يبرو](https://t.me/V_P_E)")
  elseif Text== "DARK" or Text== "دارك " then return  sendMsg(msg.chat_id_,msg.id_,"[شبح العالم ياض ♥ ](https://t.me/Ttnnt)")
  elseif Text== "التركي" or Text== "تركي " then return  sendMsg(msg.chat_id_,msg.id_,"[مبرمج سورس دوكس ](https://t.me/HH22H)")
  elseif Text== "روم التركي" or Text== "روم " then return  sendMsg(msg.chat_id_,msg.id_,"[اهي يسط اقمد روم ❅](https://t.me/ElturKeyyCHAT)")
...
return sendMsg(msg.chat_id_,msg.id_,"[ مطور البوت](https://t.me/SourceDOX) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[ منشئ المجمواع](https://t.me/SourceDOX)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[ مدير المجموعه ](https://t.me/SourceDOX)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[ ادمن ](https://t.me/SourceDOX)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[ عضو](https://t.me/SourceDOX)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انتا مرحب بيك يا مطور](https://t.me/SourceDOX) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[ منشئ المجموعه](https://t.me/SourceDOX)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[ دخلت عبر الرابط](https://t.me/SourceDOX)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[ دخلت عبر الرابط](https://t.me/SourceDOX)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[ دخلت عبر الرابط](https://t.me/SourceDOX)")
...
if not redis:get('kar') then
  ...
  json_data = '{"BotID": '..dox..',"UserBot": "'..Bot_User..'","Groups" : {'
  local All_Groups_ID = redis:smembers(dox..'group:ids')
  for key,GroupS in pairs(All_Groups_ID) do
  local NameGroup = (redis:get(dox..'group:name'..GroupS) or '')
  ...
  local admins = redis:smembers(dox..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(dox..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(dox..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(dox..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(dox..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  if redis:get(dox..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(dox..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'✦ انتهى الاشتراك في احد المجموعات .\n✦ المجموعه : '..FlterName(redis:get(dox..'group:name'..msg.chat_id_))..'.\n✦ ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'✦ انتهى الاشتراك البوت.\n✦ سوف اغادر المجموعه فرصه سعيده .\n✦ او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(dox..'ExpireDate:'..msg.chat_id_) / 86400)
